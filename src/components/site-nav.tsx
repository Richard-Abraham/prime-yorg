...
export function SiteNav() {
  ...
  return (
    <nav data-nav-variant="logo-center" className={"sticky top-0 z-50 border-b transition-all duration-300 " + (scrolled ? "border-border/60 bg-background/70 shadow-sm backdrop-blur-xl" : "border-transparent bg-transparent")}>
